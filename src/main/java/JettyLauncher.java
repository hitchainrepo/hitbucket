...
public class JettyLauncher {
    public static void main(String[] args) throws Exception {
        ...
        if (tmpDirPath.equals("")) {
            ...
            if (!tmpDir.exists()) {
                throw new java.io.FileNotFoundException(String.format("temp_dir \"%s\" not found", tmpDirPath));
            } else if (!tmpDir.isDirectory()) {
                throw new IllegalArgumentException(String.format("temp_dir \"%s\" is not a directory", tmpDirPath));
            }
        }
        ...
        if (System.getProperty("WAR", "").length() > 0
            || !System.getProperty("os.name", "Linux").startsWith("Mac")) {
